<template>
  <el-popover :visible="showPopover" :show-arrow="false" trigger="click" placement="right-start">
...
<script lang="ts" setup>
  ...
  const initEventCallback = (event: MouseEvent, element?: Base) => {
    ...
    // console.log(currentReplaceOptions.value)
